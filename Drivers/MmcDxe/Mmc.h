...
#define MMC_R0_SWITCH_ERROR                   (1 << 7)
...
#define SD_CMD6_SET_FUNCTION        BIT31
...
typedef enum {
  ...
  SD_CARD,               //SD 1.1 card
  SD_CARD_2_SDSC,        //SD 2.0 or above standard card
  SD_CARD_2_SDHC         //SD 2.0 or above high capacity card
} CARD_TYPE;
...
typedef struct _IoReadStatsEntry {
    UINT16 NumBlocks;
    UINT16 Count;
